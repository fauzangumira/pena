		...
		<div class="container">
			<div class="grid">
				<div class="row">
							...
							<center><a href="<?php echo (site_url('welcome/backmember'));?>"><button class='button inverse'>Kembali</button></a></center>
							<br/>
							<br/>
							<br/>
							<form method="post" action="<?php echo (base_url('index.php/welcome/komentpost'));?>">
							<input type="hidden" name="id_post" value="<?php echo $id_post; ?>">
							<input type="hidden" name="id" value="<?php echo $id; ?>">
							<textarea name="komentar" cols="50" rows="7" placeholder="Masukkan komentar disini" required ></textarea>
							<br/>
							<br/>
							<button type="submit" class="button inverse">Komentari</button>
							</form>
							<br/>
							<h5>Komentar</h5>
							<table class="table">
